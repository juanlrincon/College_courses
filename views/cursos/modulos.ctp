...
<div id="diplomado">
	<div id="dcol1">
		<div id="dtitulo"><?php //echo $tipo; ?>Seminarios Cortos</div>
	</div>
	<div id="dcol2">
...
*/
	...
	echo '<div class="lista1">';
		foreach($value['cursos'] as $key2 => $value2)
		{
			...
			echo '<img src="'.$this->base.'/img/script.jpg" border="0" alt="linea">';
			echo $html->link($value2, array('action' => 'umview', $key2), array('style' => 'text-decoration:none;')).'</li>';
			echo '</span></div>';
		}
	echo '</div>';
}
...
<div class="float_contenido">
	<div class="dtexto">
		...
		<div style="margin-top: 10px; margin-bottom: 10px;">
			...
			?>
			<br>
			<span class="perfil">Perfil: <?php echo $html->link($perfil, array('action' => 'umview', $curso['Curso']['id'])); ?></span>
			<br><br>
		<?php echo $html->link('Ver Más...', array('action' => 'umview', $curso['Curso']['id'])); ?>
	</div>
</div>
<?php endforeach;
*/
